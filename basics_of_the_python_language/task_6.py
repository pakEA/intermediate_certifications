...
# Пример использования с механизмом валидации
if __name__ == "__main__":
    ...
    try:
        ...
        quantity_to_transfer = int(input("Введите количество принтеров, отправленных на склад: "))
        if quantity_to_transfer <= 0:
            raise NonPositiveError(quantity_to_transfer)

        warehouse.transfer_equipment(printer1, quantity_to_transfer, "Отдел продаж")
